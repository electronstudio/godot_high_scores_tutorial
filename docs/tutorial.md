...
In Godot, open **globals.gd**.  Add these two variables, but **rather than using my values, copy 
...
7. Right click on the root node and add a child node.  Choose **HTTPRequest** as the kind of node.
